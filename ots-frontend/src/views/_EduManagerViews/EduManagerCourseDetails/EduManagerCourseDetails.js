...
import { Header, Files, Activities, Subscribers, General } from './components';
...
const EduManagerCourseDetails = props => {
...
EduManagerCourseDetails.propTypes = {
  history: PropTypes.object.isRequired,
  match: PropTypes.object.isRequired
};

export default EduManagerCourseDetails;
